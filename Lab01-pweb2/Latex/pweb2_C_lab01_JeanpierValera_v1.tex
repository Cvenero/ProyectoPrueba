...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\itemEmail}{jvalera@unsa.edu.pe}
\newcommand{\itemStudent}{Jeanpier Michaelson Valera Yana}
\newcommand{\itemCourse}{Programación Web 2}
\newcommand{\itemCourseCode}{20212110}
...
\newcommand{\itemInput}{Del 5 Mayo 2023}
\newcommand{\itemOutput}{Al 12 Mayo 2023}
...
\begin{document}
	...
	\section{Tarea}
	\begin{itemize}		
		\item Implementar y crear un repositorio GitHub .
		...
		\item Hacer un proyecto git pequeño de Java y compilar
		\item Cree un proyecto personal donde siga los pasos del tutorial de como hacer una pagina en html y css, personalice la pagina y haga commits
	\end{itemize}
	...
	\begin{itemize}
		...
		\item Programación Web y desarrollo frontend.
		\item Manejo de versiones. Git y GitHub	
	\end{itemize}
	
	\section{URL de Repositorio Github}
	\begin{itemize}
		\item URL del Repositorio GitHub para clonar o recuperar.
		\item \url{https://github.com/valeraOwner/pwb2-lab-c-23a.git}
		\item URL para el laboratorio 01 en el Repositorio GitHub.
		\item \url{https://github.com/valeraOwner/pwb2-lab-c-23a/tree/main/Lab01-pweb2}
	\end{itemize}
